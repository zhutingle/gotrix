...
var FUNC_JSON_NIL_ERROR *GotrixError = &GotrixError{Status: 2013, Msg: "执行Json操作时，JSON为空"}
var FUNC_JSONSET_NIL_ERROR *GotrixError = &GotrixError{Status: 2014, Msg: "执行JsonSet操作时，JSON为空"}
